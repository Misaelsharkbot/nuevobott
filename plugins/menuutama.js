...
let ucapWaktu = waktu > 2 && waktu < 4 ? 'Primeros ' : waktu < 11 ? 'ðŸŒ„ Buenos días' : waktu < 16 ? 'â˜€ï¸Buena tarde' : waktu < 19 ? 'ðŸŒ‡ Good Afternoon' : 'ðŸŒ™ Buenas noches'
...
soy un bot me llamo ${conn.getName(conn.user.jid)}  y fui desarrollado por @${global.kontak[0].split`@`[0]} Por favor presione el botón "MENU" Para ver la lista de comandos del bot ${conn.getName(conn.user.jid)} Ketik .listmenu
